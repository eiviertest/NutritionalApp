...
import com.eivier.nutritionalapp.model.User
...
class SignUp : AppCompatActivity(), View.OnClickListener {
    ...
    private val activity = this@SignUp
    ...
    private fun postDataToSQLite() {
        ...
        if (!databaseHelper.checkUser(textInputEditTextEmail.text.toString().trim())) {
            ...
            // Snack Bar to show success message that record saved successfully, change to Toast
            //Snackbar.make(nestedScrollView, getString(R.string.success_message), Snackbar.LENGTH_LONG).show()
            Toast.makeText(this,R.string.success_message, Toast.LENGTH_LONG).show()
            emptyInputEditText()
        } else {
            // Snack Bar to show error message that record already exists, change to Toast
